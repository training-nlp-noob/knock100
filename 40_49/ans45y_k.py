...
if __name__ == '__main__':
    ...
    # neko.txt.f1.cabochaの読み込み ここを変更
    filepath = os.path.abspath(os.path.dirname(__file__)+ "/../data/neko.txt.f1.cabocha")
    text = open(filepath, encoding="utf8").read().split("EOS\n")
    ...
    corpus = open(wfilepath, 'w', encoding="utf8")
    ...
    with open(wfilepath, encoding="utf8") as corpus:
        for line in corpus:
